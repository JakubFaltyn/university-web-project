...
import { BadgeCheck, Bell, ChevronsUpDown, LogOut, Settings, User, Users } from "lucide-react";
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-[--radix-dropdown-menu-trigger-width] min-w-56 rounded-lg" side={isMobile ? "bottom" : "right"} align="end" sideOffset={4}>
                        ...
                        {users
                            ...
                            .map((switchUser) => (
                                <DropdownMenuItem key={switchUser.id} onClick={() => handleSwitchUser(switchUser.id)} className="gap-2 p-2">
